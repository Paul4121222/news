        ...
        <div className="padding-x  flip-card">
                <video  className='card-video' autoPlay muted loop>
                    ...
                    <div className="clip-card-container">
                        <a className="clip-card-space" href={props.list[0].url} target="_blank" rel="noreferrer">
                ...
                <div className="clip-card-container">
                    ...
                    <a className="clip-card-space"  href={props.list[1].url} target="_blank" rel="noreferrer">
                ...
                <div className="clip-card-container">
                    <a className="clip-card-space"   href={props.list[2].url} target="_blank" rel="noreferrer">
                ...
                <div className="clip-card-container">
                    ...
                    <a className="clip-card-space"   href={props.list[3].url} target="_blank" rel="noreferrer">
                ...
                <div className="clip-card-container">
                    <a className="clip-card-space"   href={props.list[4].url} target="_blank" rel="noreferrer">
