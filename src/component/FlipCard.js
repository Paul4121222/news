        ...
        <div className="container padding-x  flip-card">
            ...
            <div className="card-row1">
                    ...
                    <div className="clip-card-container">
                        <div className="clip-card-space">
                                <a href={props.list[0].url} target="_blank" rel="noreferrer noopener">
                ...
                <div className="clip-card-container">
                    ...
                    <div className="clip-card-space">
                            <a href={props.list[1].url} target="_blank" rel="noreferrer noopener">
                            <div className="card-front ">
                ...
                <div className="clip-card-container">
                    <div className="clip-card-space">
                            <a href={props.list[2].url} target="_blank" rel="noreferrer noopener">
                            <div className="card-front ">
            ...
            <div className="card-row2">
                <div className="clip-card-container">
                    ...
                    <div className="clip-card-space">
                            <a href={props.list[3].url} target="_blank" rel="noreferrer noopener">
                            <div className="card-front ">
                ...
                <div className="clip-card-container">
                    <div className="clip-card-space">
                            <a href={props.list[4].url} target="_blank" rel="noreferrer noopener">
                            <div className="card-front ">
